...
export const SITE = {
  ...
  description: "Professional employment law violation tracker created by attorney Skeptical Lawyer. Document workplace violations with legal protection.",
  author: {
    name: "Skeptical Lawyer, Esq.",
